...
def check_pattern_symmetry(pattern, old_pats=(-1,-1)):
...
for i, pattern in enumerate(patterns):
    ...
    for x, row in enumerate(pattern):
        for y, _ in enumerate(row):
            ...
            pat_columns_left, pat_rows_above = check_pattern_symmetry(new_pattern, (old_columns_left, old_rows_above))
    ...
    print(i, max_rows_above, max_cols_left)
print(rows_above * 100 + columns_left)